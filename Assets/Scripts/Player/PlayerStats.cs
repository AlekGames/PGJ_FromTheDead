...
namespace Player
{
    ...
    public class PlayerStats : ScriptableObject
    {
        ...
        public float groundFriction = 60;
        ...
        [Header("DASH")][Tooltip("The amount of time we wait before being able to dash again")]
        public float dashCooldown = .5f;
        
        [Tooltip("The amount of time we wait before being able to dash again")]
        ...
        [Tooltip("The amount of time we wait before being able to dash again")]
        public float squashFactor = 0.7f;
    }
}
